...
print("=>best_acc1:{}".format(checkpoint['best_acc1']))
...
if __name__ == '__main__':
    ...
    # img5=Image.open('data/val/metal/metal400.jpg')
    # img6=Image.open('data/val/trash/trash100.jpg')
    res=predict(img1)
    print(res)
    # print(predict(img2))
    # print(predict(img3))
